...
| Cytoscape.js | Mature graph engine: layouts, A*, selectors, PNG export. Runs the Workbench fully client-side. |
...
places, countries, route, agencies, modes, quantity, value_inr, people_arrested, sources[{outlet,url,date}], n_sources, confidence`.
